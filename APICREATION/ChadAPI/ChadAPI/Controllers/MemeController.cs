...
using ChadAPI.Models;
using Microsoft.WindowsAzure.Storage.Blob;
using ChadAPI.Helper;
...
namespace ChadAPI.Controllers
{
    ...
    {
        private readonly ChadAPIContext _context;

        private IConfiguration _configuration;

        public MemeController(ChadAPIContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        {
            if (!MulipartRequestHelper.IsMultipartContentType(Request.ContentType))
            {
